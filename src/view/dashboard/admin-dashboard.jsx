                    ...
                    <li className="sidebar-menu-item">
                        <a href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="30" viewBox="0 0 32 30" fill="none">
                                <path d="M0 19.6825L4.9281 11.2375V11.232C5.56703 10.1375 6.73377 9.46521 8.00052 9.46521H26.6684V7.68732C26.6684 5.72608 25.0739 4.13153 23.1126 4.13153H16.59C15.6455 4.13153 14.7398 3.75928 14.0731 3.09257L12.6008 1.62026C11.9341 0.953545 11.0285 0.581299 10.084 0.581299H3.55579C1.59455 0.581299 0 2.17585 0 4.13709V19.6825Z" fill="#013746"/>
                                <path d="M8.00052 11.2487C7.36715 11.2487 6.78377 11.582 6.46153 12.132L6.46709 12.1265L0.24446 22.7939C-0.0777828 23.3439 -0.0777828 24.0217 0.238904 24.5773C0.555592 25.1329 1.13896 25.4718 1.77789 25.4718H16.1989C16.0686 24.8622 16 24.2298 16 23.5813C16 18.6107 20.0294 14.5813 25 14.5813C27.003 14.5813 28.8532 15.2356 30.3485 16.3422L31.7576 13.9266C32.0799 13.3766 32.0799 12.6988 31.7632 12.1432C31.4465 11.5876 30.8631 11.2487 30.2242 11.2487H8.00052Z" fill="#013746"/>
                                <path d="M24.5 29.5813C28.0899 29.5813 31 26.6712 31 23.0813C31 21.7643 30.6083 20.5388 29.9351 19.5149L24.1608 26.7328L20.1814 23.322L21.3901 21.9119L23.9107 24.0725L28.6836 18.1064C27.553 17.1547 26.0935 16.5813 24.5 16.5813C20.9101 16.5813 18 19.4914 18 23.0813C18 26.6712 20.9101 29.5813 24.5 29.5813Z" fill="#013746"/>
                            </svg>
                            Projets terminés
                        </a>
                    </li>
